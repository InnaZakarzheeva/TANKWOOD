...
const arr = [
...

  {
    ...
    photo:[ 
      require("./static/image/12B18KT/1.jpg"),
      require("./static/image/12B18KT/2.jpg"),
      require("./static/image/12B18KT/3.jpg"),
      require("./static/image/12B18KT/4.jpg"),
      require("./static/image/12B18KT/5.jpg"),
      require("./static/image/12B18KT/6.jpg"),
      require("./static/image/12B18KT/7.jpg"),
  ...
  {
    name: "ИЗМЕЛЬЧИТЕЛЬ ВЕТОК TANKWOOD 12B18KAT",
    price:"95 000 ГРН",
    description:"Измельчитель веток Tankwood 12B18KAT превосходный помощник как фермерским хозяйствам так и большим предприятиям. Обеспечивает быструю слаженную работу по переработки древесины в деловое топливо в больших количествах.",
    photo:[ 
      require("./static/image/12B18KAT/1.jpg"),
      require("./static/image/12B18KAT/2.jpg"),
      require("./static/image/12B18KAT/3.jpg"),
      require("./static/image/12B18KAT/4.jpg"),
    ],
    row_about:[ 
      'Максимальный диаметр ветки 120 мм!',
      'Длинна полученной заготовки 50-70 мм!', 
      'Производительность 12 м3/час!',
      'Расход топлива 1.2-1.5 л/час А-92!',
      'Высота выгрузки 2.9 м!', 
    ],
    row_about1:[ 
      'Большая колёсная база!', 
      'Наличие транспортёра!',
      'При рабочем положении не требуется подпорок!', 
